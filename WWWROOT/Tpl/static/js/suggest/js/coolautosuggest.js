                                    ...
                                    if (arr == null) {
                                        ...
                                        if (arr.length > 0) {
                                            for (i = 0; i < arr.length; i++) {
                                               ...
                                               html += '<div id="' + suggestRow + (i + 1) + '" class="' + cssClass + '"' + id_field + ' seq_id="' + i + '" >' + thumb + '<div class="suggestion_title">' + arr[i].address.replace(new RegExp('(' + me.textField.val() + ')', 'gi'), "<b>$1</b>") + '</div>' + desc + '</div>';
                                            }
